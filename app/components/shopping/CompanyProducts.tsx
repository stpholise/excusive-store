...
const CompanyProducts = () => {
  ...
  return (
    <div className="w-full flex flex-col min-h-fit overflow-y-hidden overflow-x-hidden gap-5 md:gap-8 lg:gap-14">
      ...
      <div className=" w-full justify-center   grid grid-cols-1 xs:grid-cols-2 gap-3 md:grid-cols-4 xl:grid-cols-5 lg:gap-x-4 xl:gap-x-6   xs:justify-between md:gap-y-6 lg:gap-y-16 ">
        {isLoading ? (
          <Skeleton height={70} />
        ) : (
          items
