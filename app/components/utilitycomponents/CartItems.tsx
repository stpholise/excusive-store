...
const CartItems = () => {
    ...
    const cumulativePrice = useSelector((state: RootState) => state.cart.totalPrice)
           ...
           <div className=" flex justify-center">
                <div className="w-96 border-gray-400 rounded-md h-fit flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between border-b-2 border-gray-300 text-sm py-2"><p className="">Subtotal:</p> <p className="">${cumulativePrice}</p></div>
                        <div className="flex justify-between border-b-2 border-gray-300 text-sm py-2"><p className="">Shipping:</p> <p className="">${shippingFee} </p></div>
                        <div className="flex justify-between border-b-2 border-gray-300 text-sm py-2"><p className="">Total:</p> <p className="">${shippingFee + cumulativePrice} </p></div>
                    </div>
                    <button  className='text-white bg-red-600 rounded-md px-4 py-3 w-80 mx-auto' >Procees to checkout</button>
                </div>
            </div>
        </div>
