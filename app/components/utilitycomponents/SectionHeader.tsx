      ...
      <div className=" flex flex-row justify-between items-center w-full ">
        {title && (
          <div className="flex flex-col gap-2 md:flex-row justify-start items-start   md:justify-between md:items-center md:w-9/12 lg:w-7/12">
            <h2 className="title text-capetalize text-xl sm:text-3xl lg:text-4xl font-semibold lg:whitespace-nowrap ">
              {title}
            </h2>
        ...
        {viewAll && (
          <div className="">
            <Link
              href={`${viewAllHref}`}
              className="viewall bg-red-600 md:px-8 md:py-2 sm:px-6 px-4 lg:px-12 py-1 sm:py-2   lg:py-4 font-medium text-white rounded-sm"
            >
              view all
            </Link>
          </div>
