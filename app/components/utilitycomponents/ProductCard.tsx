  ...
  return (
    ...
    >
      ...
      >
        <Link
          href={`/products/${slug}`}
          className="title text-sm md:text-sm lg:text-base font-medium"
        >
          <Image
        ...
        <div className="absolute z-10 top-2 right-2 md:top-2 md:right-2 lg:top-4 lg:rigth-4">
          {isAuthenticated && (
            <button
              title="wishlist"
              className="h-6 w-6 md:h-7 md:w-7 bg-white rounded-full flex items-center justify-center"
      ...
      <div className={" flex flex-col gap-1 md:gap-2"}>
        ...
        <div
          className={clsx(" flex gap-1 md:gap-2  ", {
        ...
        >
          <div className="price flex gap-5 lg:text-base md:text-sm">
            ...
            <p
              className={clsx("previous line-through text-gray-500", {
