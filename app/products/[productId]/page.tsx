...
const Page = () => {
  ...
  const { singleProduct, isLoadingSingleProduct, singleProdcutError } =
    useFetchSingleProductBySlug(slug);
        ...
        <div className="product-information w-full sm:w-[400px] h-[600px] flex flex-col justify-between ">
          <div className="flex flex-col gap-5 h-96">
            ...
            {isLoadingSingleProduct ? (
              ...
              <p className="text-sm">
                ...
                {currentProduct.detail && (
                  <PortableText value={currentProduct.detail} />
                )}
              </p>
            )}
              ...
              <div className="flex gap-4   ">
                ...
                <div className="flex items-center gap-3 ">
                  {size.map((item) => (
                    <button
                      key={item}
                      className="shadow border transition-colors duration-500 ease-in-out border-gray-600 hover:text-white hover:bg-red-600 px-1 w-7 h-6 rounded-sm"
                    >
                      {" "}
                      {item}
                    </button>
            ...
            <div className=" flex justify-between gap-4 mb-5 sm:mb-0">
              ...
              <button className=" px-5 rounded-md bg-red-600 lg:w-40 lg:h-10 text-sm font-medium text-white">
                Buy Now{" "}
              </button>
              <button
                title="wishlist"
                type="button"
                className="flex items-center justify-center border border-gra-300 w-10 h-10"
              >
                <Image
