      ...
      <div className="grid md:grid-cols-4 items-center justify-center gap-6  ">
        {
          siteStatistic.map((item, index)=> (
            <div className='px-5 py-4 border      border-gray-500 rounded-md flex flex-col items-center gap-4 group hover:bg-[#DB4444] hover:border-none' key={index} >
                ...
                <div className="group-hover:invert">
                  <h3 className="text-3xl font-bold text-center">{item.statValue}</h3>
